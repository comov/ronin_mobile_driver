...
class WashingNew extends StatefulWidget {
  const WashingNew({Key? key}) : super(key: key);

  @override
  State<WashingNew> createState() => _WashingNewState();
}

class _WashingNewState extends State<WashingNew> {
  String authToken = "";
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: ExpansionTileCard(
                      ...
                      title: const Text('Выбрать услугу'),
                      children: <Widget>[
                        const Divider(
                          thickness: 1.0,
                          height: 1.0,
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      hintText: "Пожелания и предложения",
                      focusedBorder: UnderlineInputBorder(
                        borderRadius: BorderRadius.circular(25.0),
                        borderSide: const BorderSide(
                          color: Colors.blue,
